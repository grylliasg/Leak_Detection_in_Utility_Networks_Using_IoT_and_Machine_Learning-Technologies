# TimeSeriesSplit Cross Validation on Net3
...
lags = 5
df_net3_lagged = create_lag_features(df_net3, lags)

#  Είσοδοι / στόχοι 
X_net3 = df_net3_lagged.drop(columns=df_net3.columns)  # lag features
y_net3 = df_net3_lagged[df_net3.columns]              # πραγματικές τιμές
